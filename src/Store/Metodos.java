...
public class Metodos {
    ...
    String contrasena;
    int cantidad;
    int SenseCoins = cantidad; //esta es nuestra variable Saldo
    int opcion;
        ...
        do {
            ...
            switch (opcion) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    navegador.abrirNavegadorPorDefecto("Canciones.html");
                    break;
                case 7:
                    InicioGeneral();
                    break;
    ...
    public void panelUsuarios() throws IOException {
        ...
        do {
            ...
            switch (opcion) {
                case 1:
                    crearWeb();
                    navegador.abrirNavegadorPorDefecto("Sense1.html");
                    panelUsuarios();
                    break;
                case 2:
                    comprarCancion();
                    break;
                case 3:
                    //falta añadir metodo para crear web con canciones compradas
                    //escuchar canciones compradas new pag Web
                    navegador.abrirNavegadorPorDefecto("MisCanciones.html");
                    break;
                case 4:
                    senseCoins();
                    break;
    ...
    public int getSenseCoins() { //esto seria el metodo obtenerSaldo
        return SenseCoins;
    }
    ...
    public void senseCoins() {   //esto seria el metodo obtenerSaldo
        SenseSoundLogo();
    ...
    public void comprarSenseCoins() throws FileNotFoundException { //metodo de añadir Saldo
        ...
        cantidad = in.nextInt();
        setSenseCoins(getSenseCoins()+cantidad);
        crearWeb();
    ...
    public void comprarCancion() {
        ...
        if (song.getPrice() <= getSenseCoins()) {
            setSenseCoins(getSenseCoins() - price);
            op.buySong(index);
    ...
    public void crearWeb() throws FileNotFoundException {
        PrintWriter archivoDeSalida = new PrintWriter("Sense1.html");
        archivoDeSalida.println("<!DOCTYPE html>\n" +
                "<html lang=\"en\">\n" +
                "<head>\n" +
                "\t<meta charset=\"UTF-8\">\n" +
                ...
                "\t\t\t\t\t\t<source src=\"sound/trial/trialPop/Morat.m4a\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialPop/Feelings.mp3\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialPop/Amor.m4a\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialPop/TeAmo.mp3\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<!--<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialPop/HowYou.m4a\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>-->\n" +
                "\t\t\t</tr>\n" +
                "\t\t\t\n" +
                ...
                "\t\t\t<tr>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<h4 align=\"center\">Por mi no te detengas<br>Banda MS<br><i>#00015</i><br><img src=\"img/senseCoin.png\" width=\"30\" height=\"30\" align=\"center\">15 coins</h4>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<h4 align=\"center\">El color de tus ojos<br>Banda MS<br><i>#00016</i><br><img src=\"img/senseCoin.png\" width=\"30\" height=\"30\" align=\"center\">15 coins</h4>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<h4 align=\"center\">A traves del vaso<br>Banda Los Sebastianes<br><i>#00017</i><br><img src=\"img/senseCoin.png\" width=\"30\" height=\"30\" align=\"center\">15 coins</h4>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<h4 align=\"center\">Las cosas no se hacen así<br>Banda MS<br><i>#00018</i><br><img src=\"img/senseCoin.png\" width=\"30\" height=\"30\" align=\"center\">15 coins</h4>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<h4 align=\"center\">Aerolinea carrillo<br>Tercer Elemento<br><i>#00019</i><br><img src=\"img/senseCoin.png\" width=\"30\" height=\"30\" align=\"center\">15 coins</h4>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t</tr>\n" +
                "\t\t\t<tr>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialBanda/noTeDetengas.m4a\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialBanda/ojos.m4a\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialBanda/vaso.m4a\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialBanda/cosas.m4a\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialBanda/aerolinea.m4a\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t</tr>\n" +
                "\t\t\t<tr>\n" +
                ...
                "\t\t\t\t\t\t<br>Julieta Venegas & Los Angeles Azules<br><i>#00010</i><br><img src=\"img/senseCoin.png\" width=\"30\" height=\"30\" align=\"center\">15 coins</h4>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<h4 align=\"center\">Oye mujer<br>Raymix<br><i>#00011</i><br><img src=\"img/senseCoin.png\" width=\"30\" height=\"30\" align=\"center\">15 coins</h4>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<h4 align=\"center\">17 años<br>Los Angeles Azules<br><i>#00012</i><br><img src=\"img/senseCoin.png\" width=\"30\" height=\"30\" align=\"center\">15 coins</h4>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<h4 align=\"center\">Primer Beso<br>Raymix<br><i>#00013</i><br><img src=\"img/senseCoin.png\" width=\"30\" height=\"30\" align=\"center\">15 coins</h4>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<h4 align=\"center\">Mis sentimientos<br>Los Angeles Azules <br>& Ximena Sariñana<br><i>#00014</i><br><img src=\"img/senseCoin.png\" width=\"30\" height=\"30\" align=\"center\">15 coins</h4>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t</tr>\n" +
                "\t\t\t<tr>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialCumbias/acariñameP.mp3\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialCumbias/oye.m4a\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialCumbias/17años.m4a\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialCumbias/beso.m4a\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialCumbias/sentimientos.m4a\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t</tr>\n" +
                "\t\t\t\t\t\t\n" +
                ...
                "\t\t\t<tr>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<h4 align=\"center\">In my mind<br>Dynoro & D´ Agostino<br><i>#00025</i><br><img src=\"img/senseCoin.png\" width=\"30\" height=\"30\" align=\"center\">15 coins</h4>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<h4 align=\"center\">Turn it up<br>Armin Van Buuren<br><i>#00026</i><br><img src=\"img/senseCoin.png\" width=\"30\" height=\"30\" align=\"center\">15 coins</h4>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<h4 align=\"center\">Baila conmigo<br>Victor Cardenas feat. Kelly Ruiz<br><i>#00027</i><br><img src=\"img/senseCoin.png\" width=\"30\" height=\"30\" align=\"center\">15 coins</h4>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<h4 align=\"center\">Al pacino<br>Timmy Trumpet<br><i>#00028</i><br><img src=\"img/senseCoin.png\" width=\"30\" height=\"30\" align=\"center\">15 coins</h4>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<h4 align=\"center\">Enzo<br>DJ Snake<br><i>#00029</i><br><img src=\"img/senseCoin.png\" width=\"30\" height=\"30\" align=\"center\">15 coins</h4>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t</tr>\n" +
                "\t\t\t<tr>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialDance/In_my_mind.mp3\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialDance/TurnItUp.mp3\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialDance/BailaConmigo.mp3\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialDance/alPacino.mp3\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialDance/Enzo.mp3\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t</tr>\n" +
                "\t\t\t<tr>\n" +
                ...
                "\t\t\t<tr>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<h4 align=\"center\">NADIE<br>Sech Remix<br><i>#00030</i><br><img src=\"img/senseCoin.png\" width=\"30\" height=\"30\" align=\"center\">15 coins</h4>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<h4 align=\"center\">Otro trago Remix<br>Sech & Darell & Nicky Jam & Ozuna<br><i>#00031</i><br><img src=\"img/senseCoin.png\" width=\"30\" height=\"30\" align=\"center\">15 coins</h4>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<h4 align=\"center\">Rebota<br>Guaynaa<br><i>#00032</i><br><img src=\"img/senseCoin.png\" width=\"30\" height=\"30\" align=\"center\">15 coins</h4>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<h4 align=\"center\">HP<br>Maluma<br><i>#00033</i><br><img src=\"img/senseCoin.png\" width=\"30\" height=\"30\" align=\"center\">15 coins</h4>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<h4 align=\"center\">Con calma<br>Daddy Yankee<br><i>#00034</i><br><img src=\"img/senseCoin.png\" width=\"30\" height=\"30\" align=\"center\">15 coins</h4>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t</tr>\n" +
                "\t\t\t<tr>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialRegue/Nadie.mp3\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialRegue/Trago.mp3\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialRegue/Rebota.mp3\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialRegue/HP.mp3\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialRegue/ConCalma.mp3\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t</tr>\n" +
                "\t\t\t<tr>\n" +
                ...
                "\t\t\t<tr>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<h4 align=\"center\">Hotel California<br>The Eagles<br><i>#00035</i><br><img src=\"img/senseCoin.png\" width=\"30\" height=\"30\" align=\"center\">15 coins</h4>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<h4 align=\"center\">I just called to say I love you<br>Stevie Wonder<br><i>#00036</i><br><img src=\"img/senseCoin.png\" width=\"30\" height=\"30\" align=\"center\">15 coins</h4>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<h4 align=\"center\">Losing my religion<br>R.E.M<br><i>#00037</i><br><img src=\"img/senseCoin.png\" width=\"30\" height=\"30\" align=\"center\">15 coins</h4>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<h4 align=\"center\">Sweet dreams<br>Eurythmics<br><i>#00038</i><br><img src=\"img/senseCoin.png\" width=\"30\" height=\"30\" align=\"center\">15 coins</h4>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<h4 align=\"center\">Happy together<br>The turtles<br><i>#00039</i><br><img src=\"img/senseCoin.png\" width=\"30\" height=\"30\" align=\"center\">15 coins</h4>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t</tr>\n" +
                "\t\t\t<tr>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialRock/Hotel.mp3\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialRock/OnlySay.mp3\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialRock/rem.mp3\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialRock/Sweet.mp3\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialRock/Happy.mp3\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t</tr>\n" +
                "\t\t\t<tr>\n" +
                ...
                "\t\t\t<tr>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<h4 align=\"center\">Oye<br>Taini feat. Sebastian Yatra<br><i>#00040</i><br><img src=\"img/senseCoin.png\" width=\"30\" height=\"30\" align=\"center\">15 coins</h4>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<h4 align=\"center\">Tal vez<br>Paulo Londa<br><i>#00041</i><br><img src=\"img/senseCoin.png\" width=\"30\" height=\"30\" align=\"center\">15 coins</h4>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<h4 align=\"center\">Ya no tiene novio<br>Sebastian Yatra & Mau y Ricky<br><i>#00042</i><br><img src=\"img/senseCoin.png\" width=\"30\" height=\"30\" align=\"center\">15 coins</h4>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<h4 align=\"center\">Forever alone<br>Paulo Londra<br><i>#00043</i><br>\n" +
                "\t\t\t\t\t<img src=\"img/senseCoin.png\" width=\"30\" height=\"30\" align=\"center\">15 coins</h4>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<h4 align=\"center\">Solo pienso en ti<br>Paulo Londra ft. De la Guetto<br><i>#00044</i><br>\n" +
                "\t\t\t\t\t<img src=\"img/senseCoin.png\" width=\"30\" height=\"30\" align=\"center\">15 coins</h4>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t</tr>\n" +
                "\t\t\t<tr>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialUrban/Oye.mp3\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialUrban/TalVez.mp3\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialUrban/YaNoTieneNovio.mp3\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialUrban/ForeverAlone.mp3\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t\t<td>\n" +
                "\t\t\t\t\t<audio width=\"100\" controls>\n" +
                "\t\t\t\t\t\t<source src=\"sound/trial/trialUrban/SoloPiensoEnTi.mp3\" type=\"audio/mp3\">\n" +
                "\t\t\t\t\t</audio>\n" +
                "\t\t\t\t</td>\n" +
                "\t\t\t</tr>\n" +
                "\t\t</table>\n" +
